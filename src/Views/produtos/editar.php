...
<form method="POST" action="/produtos/editar/<?= $produto->id ?>" class="mt-4">
    <div class="mb-3">
    ...
    <div class="mt-4"><?php require __DIR__ . '/../layout/header.php'; ?>
...
<?php require __DIR__ . '/../layout/footer.php'; ?>
        <button type="submit" class="btn btn-primary">Atualizar Produto</button>
        <a href="/sysfin-tds2/public/produtos" class="btn btn-secondary">Cancelar</a>
    </div>
</form>
